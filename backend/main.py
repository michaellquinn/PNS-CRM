...
# Parked, NOT lost (Michael, 2026-08-31). "Future Opportunity" means budget moved or the
        ...
        async with httpx.AsyncClient(
            ...
            for label, items in batches:
                ...
                for o in items:
                    ...
                    # imported (Michael, 2026-08-31) so the deal exists here with
